...
const StudentLayout = () => {
    ...
    const navItems = [
        ...
        { icon: Users, label: 'Find Alumni', path: '/student/alumni' },
        { icon: MessageSquarePlus, label: 'Ask Query', path: '/student/create-query' },
        { icon: History, label: 'My Queries', path: '/student/queries' },
                ...
                <header className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-slate-500">
                            {user.batch ? `Batch of ${user.batch}` : 'Student Member'}
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/student/profile" className="flex items-center gap-3 pl-2 pr-4 py-1.5 rounded-full bg-white border border-slate-200 hover:border-blue-200 transition-colors">
